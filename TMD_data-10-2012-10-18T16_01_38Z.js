...
function loadTransitionsMembersLinks(){ // FIXME : Complete me
	...
	gTransitionsMembersLinksTable.addRows([
		...
		*/
		...
		['Afr-T1-inter', 'Afr', 'T1', 'inter'],
		['Afr-T2-inter', 'Afr', 'T2', 'inter'],
		['Tli-T10-inter', 'Tli', 'T10', 'inter'],
		['Dph-T9-inter', 'Dph', 'T9', 'inter'],
		['Cta-T2-inter', 'Cta', 'T2', 'inter'],
		['Hma-T4-inter', 'Hma', 'T5', 'inter'],
		/*
		// Pierre Livet vs les 12 transitions
		['Pli-T1-inter', 'Pli', 'T1', 'inter'],
		['Pli-T2-inter', 'Pli', 'T2', 'inter'],
		['Pli-T3-inter', 'Pli', 'T3', 'inter'],
		['Pli-T4-inter', 'Pli', 'T4', 'inter'],
		['Pli-T5-inter', 'Pli', 'T5', 'inter'],
		['Pli-T6-inter', 'Pli', 'T6', 'inter'],
		['Pli-T7-inter', 'Pli', 'T7', 'inter'],
		['Pli-T8-inter', 'Pli', 'T8', 'inter'],
		['Pli-T9-inter', 'Pli', 'T9', 'inter'],
		['Pli-T10-inter', 'Pli', 'T10', 'inter'],
		['Pli-T11-inter', 'Pli', 'T11', 'inter'],
		['Pli-T12-inter', 'Pli', 'T12', 'inter'],		
		*/
				// PORTEURS
