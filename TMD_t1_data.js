...
function loadDimensionsLinks(){
    ...
    gDimensionsLinksTable.addRows([
        ['11-16', '11', '16', 'direct-sur', 'arrow-end', 1.5, 'black'],
        ['11-18', '11', '18', 'direct-sur', 'arrow-end', 1.5, 'black'],
        ['18-10', '18', '10', 'direct-sur', 'arrow-end', 1.5, 'black'],
        ['16-10', '16', '10', 'direct-sur', 'arrow-end', 1.5, 'black'],
        ['11-12', '11', '12', 'direct-sur', 'arrow-end', 1.5, 'black'],
        ['11-13', '11', '13', 'direct-sur', 'arrow-end', 1.5, 'black'],

        ['10-17', '10', '17', 'direct-suppose', 'arrow-end', 0.75, 'grey'],
        ['15-17', '15', '17', 'direct-suppose', 'arrow-end', 0.75, 'grey'],
        ['17-2', '17', '2', 'direct-suppose', 'arrow-end', 0.75, 'grey'],
        ['17-12', '17', '12', 'direct-suppose', 'arrow-end', 0.75, 'grey'],
        ['17-13', '17', '13', 'direct-suppose', 'arrow-end', 0.75, 'grey'],
        ['15-16', '15', '16', 'direct-suppose', 'arrow-end', 0.75, 'grey'],
        ['15-18', '15', '18', 'direct-suppose', 'arrow-end', 0.75, 'grey'],
        ...
        ['14-12b', '14', '12', 'condition-necessaire', 'dash-line', 0.75, 'grey'],
        ['14-13b', '14', '13', 'condition-necessaire', 'dash-line', 0.75, 'grey'],
        ['12-15b', '12', '15', 'condition-necessaire', 'dash-line', 0.75, 'grey'],
        ['13-15b', '13', '15', 'condition-necessaire', 'dash-line', 0.75, 'grey'],
        ['18-15b', '18', '15', 'condition-necessaire', 'dash-line', 0.75, 'grey'],
        ['16-15b', '16', '15', 'condition-necessaire', 'dash-line', 0.75, 'grey']
    ]);
